class MockettaroAjaxRecorderWebpack {
  constructor({NODE_ENV = 'development'} = { NODE_ENV: 'development' }) {
    ...
    const fontsExtensions = ["eot", "otf", "svg", "ttf", "woff", "woff2"];
...
module.exports = (...cfg) => new MockettaroAjaxRecorderWebpack(...cfg);
